...
while True:
    ...
    if ( buy_count == 0 ) :
        ...
        if ( 855<now_time and now_time<857 ) or ( 2355<now_time and now_time<2357 ):
    ...
    if (short_in == 1):
        ...
        if ( pyupbit.get_current_price("KRW-BTG") < buy_price * (1 - up_low) )  or ( pyupbit.get_current_price("KRW-BTG") > buy_price * (1 + up_in) )  or  ( 930<now_time and now_time<932  ) or ( 30<now_time and now_time<32  ) :
